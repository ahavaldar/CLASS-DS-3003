...
- In such as case, you can (i) use `renderUI` to create an input element depending on server-side values and (ii) display the input element with `uiOutput`
